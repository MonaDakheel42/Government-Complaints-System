...
INSERT INTO `auditlog` VALUES (1,1,'admin','GET','GET /government/2/showEmployee','{\"params\":{\"id\":\"2\"},\"query\":{}}','SUCCESS','2025-12-01 08:16:28.094'),(2,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{}}','SUCCESS','2025-12-01 08:19:25.211'),(3,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{}}','SUCCESS','2025-12-01 08:22:56.157'),(4,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{}}','FAILED','2025-12-01 08:23:05.008'),(5,1,'admin','GET','GET /government/1/showEmployee','{\"params\":{\"id\":\"1\"},\"query\":{}}','SUCCESS','2025-12-01 08:23:39.489'),(6,1,'admin','GET','GET /government/1/showEmployee','{\"params\":{\"id\":\"1\"},\"query\":{}}','SUCCESS','2025-12-01 08:34:30.826'),(7,1,'admin','GET','GET /government/100/showEmployee','{\"params\":{\"id\":\"100\"},\"query\":{},\"error\":\"government with ID 100 does not exist\"}','FAILED','2025-12-01 08:34:49.854'),(8,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{},\"error\":\"incorrect password try again\"}','FAILED','2025-12-01 08:35:00.381'),(9,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{},\"error\":\"incorrect password try again\"}','FAILED','2025-12-01 08:35:00.432'),(10,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{}}','SUCCESS','2025-12-01 08:35:11.079'),(11,1,'admin','GET','GET /government/1/showEmployee','{\"params\":{\"id\":\"1\"},\"query\":{}}','SUCCESS','2025-12-01 09:20:21.348'),(12,0,'anonymous','POST','POST /backup','{\"params\":{},\"query\":{},\"error\":\"Command failed: mysqldump -h localhost -u root -p complaints_system > \\\"D:\\\\Nest js\\\\Government-Complaints-System\\\\backups\\\\mysql-backup-2025-12-01T21-22-58-189Z.sql\\\"\\n\'mysqldump\' is not recognized as an internal or external command,\\r\\noperable program or batch file.\\r\\n\"}','FAILED','2025-12-01 21:22:58.369'),(13,0,'anonymous','POST','POST /backup','{\"params\":{},\"query\":{},\"error\":\"Command failed: mysqldump -h localhost -u root -p complaints_system > \\\"D:\\\\Nest js\\\\Government-Complaints-System\\\\backups\\\\mysql-backup-2025-12-01T21-22-58-189Z.sql\\\"\\n\'mysqldump\' is not recognized as an internal or external command,\\r\\noperable program or batch file.\\r\\n\"}','FAILED','2025-12-01 21:22:58.603'),(14,0,'anonymous','POST','POST /backup','{\"params\":{},\"query\":{}}','SUCCESS','2025-12-01 21:26:27.509'),(15,0,'anonymous','POST','POST /backup','{\"params\":{},\"query\":{}}','SUCCESS','2025-12-01 21:27:02.139'),(16,0,'anonymous','GET','GET /backup','{\"params\":{},\"query\":{},\"error\":\"Unauthorized\"}','FAILED','2025-12-02 10:46:46.388'),(17,1,'admin','GET','GET /backup','{\"params\":{},\"query\":{}}','SUCCESS','2025-12-02 10:47:08.277'),(18,0,'anonymous','POST','POST /auth/login-user','{\"body\":{\"email\":\"sara@example.com\",\"password\":\"[REDACTED]\"},\"params\":{},\"query\":{}}','SUCCESS','2025-12-02 10:47:25.248'),(19,2,'user','GET','GET /backup','{\"params\":{},\"query\":{},\"error\":\"Unauthorized: Admins only\"}','FAILED','2025-12-02 10:47:33.347'),(20,2,'user','GET','GET /backup','{\"params\":{},\"query\":{},\"error\":\"Unauthorized: Admins only\"}','FAILED','2025-12-02 10:47:33.353'),(21,1,'admin','GET','GET /backup','{\"params\":{},\"query\":{}}','SUCCESS','2025-12-02 10:47:46.990'),(22,1,'admin','GET','GET /admins/showLogs','{\"params\":{},\"query\":{}}','SUCCESS','2025-12-02 10:59:09.061'),(23,0,'anonymous','GET','GET /admins/showLogs','{\"params\":{},\"query\":{},\"error\":\"Unauthorized\"}','FAILED','2025-12-02 10:59:18.539'),(24,2,'user','GET','GET /admins/showLogs','{\"params\":{},\"query\":{},\"error\":\"Unauthorized: Admins only\"}','FAILED','2025-12-02 10:59:42.304'),(25,2,'user','GET','GET /admins/showLogs','{\"params\":{},\"query\":{},\"error\":\"Unauthorized: Admins only\"}','FAILED','2025-12-02 10:59:42.309'),(26,1,'admin','GET','GET /admins/showLogs','{\"params\":{},\"query\":{}}','SUCCESS','2025-12-02 11:00:01.503'),(27,1,'admin','GET','GET /admins/showLogs/aa','{\"params\":{\"id\":\"aa\"},\"query\":{},\"error\":\"\\nInvalid `model.findUnique()` invocation in\\nD:\\\\Nest js\\\\Government-Complaints-System\\\\src\\\\Aspects\\\\CheckIdExistAspect.ts:33:32\\n\\n  30   throw new NotFoundException(`Model \'${table}\' not found in DbService.`);\\n  31 }\\n  32 \\n→ 33 const record = await model.findUnique({\\n       where: {\\n     +   id: Int\\n       }\\n     })\\n\\nArgument `id` is missing.\"}','FAILED','2025-12-02 11:03:40.690'),(28,1,'admin','GET','GET /admins/showLogs/5','{\"params\":{\"id\":\"5\"},\"query\":{}}','SUCCESS','2025-12-02 11:04:33.327'),(29,0,'anonymous','GET','GET /admins/showLogs/5','{\"params\":{\"id\":\"5\"},\"query\":{},\"error\":\"Unauthorized\"}','FAILED','2025-12-02 11:04:45.097'),(30,2,'user','GET','GET /admins/showLogs/5','{\"params\":{\"id\":\"5\"},\"query\":{},\"error\":\"Unauthorized: Admins only\"}','FAILED','2025-12-02 11:05:05.356'),(31,2,'user','GET','GET /admins/showLogs/5','{\"params\":{\"id\":\"5\"},\"query\":{},\"error\":\"Unauthorized: Admins only\"}','FAILED','2025-12-02 11:05:05.399'),(32,1,'admin','GET','GET /admins/showLogs/555','{\"params\":{\"id\":\"555\"},\"query\":{},\"error\":\"auditLog with ID 555 does not exist\"}','FAILED','2025-12-02 11:05:26.655'),(33,1,'admin','GET','GET /admins/showLogs/5','{\"params\":{\"id\":\"5\"},\"query\":{}}','SUCCESS','2025-12-02 11:05:39.272');
...
INSERT INTO `backuplog` VALUES (1,'mysql-backup-2025-12-01T21-26-27-006Z.sql','2025-12-01 21:26:27.492'),(2,'mysql-backup-2025-12-01T21-27-01-763Z.sql','2025-12-01 21:27:02.084'),(3,'mysql-backup-2025-12-01T22-48-00-039Z.sql','2025-12-01 22:48:00.354'),(4,'mysql-backup-2025-12-01T22-50-00-037Z.sql','2025-12-01 22:50:00.373'),(5,'mysql-backup-2025-12-01T22-55-00-024Z.sql','2025-12-01 22:55:00.299'),(6,'mysql-backup-2025-12-01T23-00-00-042Z.sql','2025-12-01 23:00:00.417'),(7,'mysql-backup-2025-12-01T23-02-00-030Z.sql','2025-12-01 23:02:00.392'),(8,'mysql-backup-2025-12-01T23-03-00-024Z.sql','2025-12-01 23:03:00.415'),(9,'mysql-backup-2025-12-01T23-04-00-019Z.sql','2025-12-01 23:04:00.357'),(10,'mysql-backup-2025-12-01T23-05-00-011Z.sql','2025-12-01 23:05:00.359'),(11,'mysql-backup-2025-12-01T23-06-00-013Z.sql','2025-12-01 23:06:00.383'),(12,'mysql-backup-2025-12-01T23-07-00-023Z.sql','2025-12-01 23:07:00.362'),(13,'mysql-backup-2025-12-01T23-08-00-030Z.sql','2025-12-01 23:08:00.362');
...
INSERT INTO `user` VALUES (1,'Abdallah Salem','abdallah@example.com','+218910000001','$2b$10$fmXCDIHUWREtLeW.n3GOAOBrHl6AzMRI2xagoBFbdDb8sGh09p0le',1,NULL,NULL,0,NULL,'2025-11-30 19:08:11.792','2025-11-30 19:08:11.792'),(2,'Sara Khaled','sara@example.com','+218910000002','$2b$10$fmXCDIHUWREtLeW.n3GOAOBrHl6AzMRI2xagoBFbdDb8sGh09p0le',1,NULL,NULL,0,'$2b$10$wzlqywQ9ffuprxCEZU/DzuOEsMctrhc.gVEDcyNrwelEXaHeWDRdO','2025-11-30 19:08:11.798','2025-12-02 10:47:25.236'),(3,'meme','memeahmed22004@gmail.com','167897490','$2b$10$TbIDt6rPobbFSAUyjmtElOFxB/bGGMcUJ92/acTr6.oIPeleC7bxS',0,'841481','2025-11-30 20:12:14.757',0,NULL,'2025-11-30 20:02:14.786','2025-11-30 20:02:14.786'),(4,'aya','aya@gmail.com','0940759183','$2b$10$SAO3/lY2oSI8iUq5xscG1.hO8lfPTGRg8sFtucBeyIl/bneC0mgBC',0,'735216','2025-11-30 20:12:45.137',0,NULL,'2025-11-30 20:02:45.139','2025-11-30 20:02:45.139');
...
-- Dump completed on 2025-12-02 17:19:01
